...
# find rules that have minimum support and confidence = 1% and 30%, with at least two items
...
# find rules with specific items in antecedent set that have minimum support and confidence being 1\% and 1\%
